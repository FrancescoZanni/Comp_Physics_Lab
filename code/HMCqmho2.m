function [PhiOUT,acc] = HMCqmho2(m0,omg0,NT,epsilon,Nhmc,Niter,Phi0)
%Monte Carlo implementation. The function outputs all the "Niter" different
%trajectories obtained

    if (nargin==6)
        Phi = zeros(1,round(NT));
    else
        Phi = Phi0;
    end
